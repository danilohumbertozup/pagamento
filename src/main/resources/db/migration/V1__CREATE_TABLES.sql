...
CREATE TABLE FORMA_PAGAMENTO (
  id SERIAL NOT NULL PRIMARY KEY,
  id_tipo_forma_pagamento SERIAL NOT NULL,
...
ALTER TABLE public.forma_pagamento ADD CONSTRAINT forma_pagamento_un UNIQUE (id_tipo_forma_pagamento);
ALTER TABLE public.usuario ADD CONSTRAINT usuario_un UNIQUE (email,id_forma_pagamento);

ALTER TABLE public.forma_pagamento ADD CONSTRAINT forma_pagamento_fk FOREIGN KEY (id_tipo_forma_pagamento) REFERENCES public.tipo_forma_pagamento(id);
